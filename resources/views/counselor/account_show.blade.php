            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Student Inforamtion</h4>
                    </div>
                    <div class="navbar-right">
                        <a href="{{url('account_pdf', $data->id)}}" class="btn btn-lg btn-danger" target="_blank" style="border-radius:0px;"><i class="fa fa-print"></i> Print</a>
                        <a href="{{url('home')}}" class="btn btn-lg btn-primary" style="border-radius:0px;"><i class="fa fa-backward"></i> Back To Previous Page</a>
                    </div>
                </div>
            </div>
            <div class="content">
                                ...
                                <div class="invoice">
                                    ...
                                    <table class="table table-bordered" style="width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:12px; text-align:center;">Admission</td>
