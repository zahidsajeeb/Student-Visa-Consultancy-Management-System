            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Student Information</h4>
                    </div>
                    <div class="navbar-right">
                        <a href="{{url('follow_up_pdf', $data->id)}}" class="btn btn-lg btn-danger" style="border-radius:0px;"><i class="fa fa-print"></i> Print</a>
                        <a href="{{url('follow_up_edit', $data->id)}}" class="btn btn-lg btn-primary" style="border-radius:0px;"><i class="fa fa-edit"></i> Edit</a>
                        <a href="{{url('home')}}" class="btn btn-sm btn-danger" style="border-radius:0px;"><i class="icon icon-backward2"></i> Back to Previous Page</a>
                    </div>
                </div>
            </div>
            <div class="content">
                            ...
                            <div class="card-body">
                                ...
                                <div class="invoice">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            @if($data->student_img == null)
                                                <td rowspan="5" style="width:40%; text-align:center;">
                                                    <img src="{{ asset('upload/profile.jpg') }}" height="250" width="250">
                                                </td>
                                            @else
                                                <td rowspan="5" style="width:40%; text-align:center;">
                                                    <img src="{{ asset('upload/' . $data->student_img) }}" height="250" width="250">
                                                </td>
                                            @endif
                                            <td style="width:20%;background:#f7f7f7; font-weight:bold; font-size:15px; text-align:center;">Student Name</td>
                                            <td style="width:40%;text-align:center; font-size:13px; word-break:break-all; word-wrap:break-word;">{{$data->student_name}}</td>
                                        </tr>
                                        <tr>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:15px; text-align:center;">Counselor Name</td>
                                            <td style="text-align:center; font-size:13px; word-break:break-all; word-wrap:break-word;">
                                                @php
                                        ...
                                        <tr>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:15px; text-align:center;">Token</td>
                                            <td style="text-align:center; font-size:13px; word-break:break-all; word-wrap:break-word;">{{$data->student_id}}</td>
                                        </tr>
                                        <tr>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:15px; text-align:center;">Email</td>
                                            <td style="text-align:center; font-size:13px; word-break:break-all; word-wrap:break-word;">{{$data->student_email}}</td>
                                        </tr>
                                        <tr>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:15px; text-align:center;">Create Date/Time</td>
                                            <td style="width:20%;text-align:center; font-size:13px; word-break:break-all; word-wrap:break-word;">{{$data->created_at}}</td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table table-bordered" style="width:100%;">
                                        ...
                                        <tr>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:12px; text-align:center;">Sl no</td>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:12px; text-align:center;">Counseling Date</td>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:12px; text-align:center;">Counseling Purpose</td>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:12px; text-align:center;">Counselor Name</td>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:12px; text-align:center;">Note</td>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:12px; text-align:center;">Commitment</td>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:12px; text-align:center;">Next Appointment Date</td>
                                            <td style="background:#f7f7f7; font-weight:bold; font-size:12px; text-align:center;">Status</td>
                                        ...
                                        @foreach($history as $key=>$result)
                                            <tr>
                                                ...
                                                <td style="text-align:center;">{{$result->purpose}}</td>
                                                ...
                                                <td style="text-align:center;">
                                                    @if($result->next_app_date!=null)
                                                        {{$result->next_app_date}}
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                ...
                                <div class="information" style="width:100%; bottom: 0;">
