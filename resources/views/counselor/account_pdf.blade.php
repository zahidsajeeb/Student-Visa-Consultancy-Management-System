...
<div class="invoice">
    ...
    <table border="1" style="table-layout: fixed; width:95%;">
        ...
        <tr>
            ...
            <td style="background:#f7f7f7; font-weight:bold; font-size:10px; text-align:center; width:20%;">Counseling Date</td>
            <td style="background:#f7f7f7; font-weight:bold; font-size:10px; text-align:center; width:20%;">Counseling Purpose</td>
            <td style="background:#f7f7f7; font-weight:bold; font-size:10px; text-align:center; width:20%;">Counselor Name</td>
            <td style="background:#f7f7f7; font-weight:bold; font-size:10px; text-align:center; width:20%;">Admission</td>
        ...
        @foreach($history as $key=>$result)
            <tr>
                ...
                <td style="text-align:center; font-size:10px; word-break:break-all; word-wrap:break-word;">OK</td>
                <td style="text-align:center; font-size:10px; word-break:break-all; word-wrap:break-word;">
                    @if($result->active=='1')
                        Active
                    @else
