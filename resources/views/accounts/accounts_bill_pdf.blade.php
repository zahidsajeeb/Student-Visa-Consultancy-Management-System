...
<div class="invoice">
    <table border="1" style="width:95%;">
        <tr>
            <td colspan="4" style="background:#083078d4;color:wheat; font-size:18px; font-weight:bold; height:50px!important; text-align:center;"> Money Receipt</td>
        </tr>
        <tr>
            <td style="background:#f7f7f7; font-weight:bold;height:25px !important; padding:5px;"> Student Name</td>
            <td colspan="3" style="padding:5px;"> {{$payment_info->student_name}} </td>
        </tr>
        <tr>
            <td style="background:#f7f7f7; font-weight:bold; height:25px !important; padding:5px;"> Student ID</td>
            <td colspan="3" style="padding:5px;"> {{$payment_info->student_id}} </td>
        </tr>
        <tr>
            <td style="background:#f7f7f7; font-weight:bold; height:25px !important; padding:5px;"> Payment Purpose</td>
            <td style="padding:5px;"> {{$payment_info->payment_purpose}} </td>
