            ...
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Admission Payment List</h4>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title" style="font-weight:bold;text-align:center;">Admission Payment List</h5>
                                <hr>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="table table-bordered" style="border:1px solid;">
                                        ...
                                        @foreach($data as $key=>$result)
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    @if(isset($admission_payment))<span style="background:green;color:white;padding:7px;"><i class="fa fa-check"></i> Done</span>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <table id="example1" class="table table-condensed">
                                                        ...
                                                        <tr><td>Service Charge</td></tr>
                                                        {{--                                                        @endforeach--}}
                                                    </table>
                                                </td>
                                                <td style="text-align:center;">
                                                    <table id="example1" class="table table-nostriped">
                                                        <tr><td>@if(isset($admission_payment))<span style="background:green;color:white;padding:7px;"><i class="fa fa-check"></i> Done</span>   @else <span style="background:darkred;color:white;padding:7px;"><i class="fa fa-close"></i> Not Done</span>  @endif</td></tr>
                                                        <tr><td>@if(isset($step1_payment))<span style="background:green;color:white;padding:7px;"><i class="fa fa-check"></i> Done</span> @else <span style="background:darkred;color:white;padding:7px;"><i class="fa fa-check"></i> Not Done</span>  @endif</td></tr>
                                                        <tr><td>@if(isset($step2_payment)) <span style="background:green;color:white;padding:7px;"><i class="fa fa-check"></i> Done</span> @else <span style="background:darkred;color:white;padding:7px;"><i class="fa fa-check"></i> Not Done</span> @endif</td></tr>
                                                        <tr><td>@if(isset($step3_payment))<span style="background:green;color:white;padding:7px;"><i class="fa fa-check"></i> Done</span> @else <span style="background:darkred;color:white;padding:7px;"><i class="fa fa-check"></i> Not Done</span> @endif</td></tr>
                                                        <tr><td>@if(isset($step4_payment)) <span style="background:green;color:white;padding:7px;"><i class="fa fa-check"></i> Done</span> @else<span style="background:darkred;color:white;padding:7px;"><i class="fa fa-check"></i> Not Done</span> @endif</td></tr>
                                                        <tr><td>@if(isset($step5_payment)) <span style="background:green;color:white;padding:7px;"><i class="fa fa-check"></i> Done</span> @else <span style="background:darkred;color:white;padding:7px;"><i class="fa fa-check"></i> Not Done</span> @endif</td></tr>
                                                        <tr><td>@if(isset($processing_payment)) <span style="background:green;color:white;padding:7px;"><i class="fa fa-check"></i> Done</span> @else <span style="background:darkred;color:white;padding:7px;"><i class="fa fa-check"></i> Not Done</span> @endif</td></tr>
                                                        <tr><td>@if(isset($service_payment)) <span style="background:green;color:white;padding:7px;"><i class="fa fa-check"></i> Done</span> @else <span style="background:darkred;color:white;padding:7px;"><i class="fa fa-check"></i> Not Done</span> @endif</td></tr>
