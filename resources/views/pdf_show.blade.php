...
<div class="invoice">
    ...
    <table border="1" style="table-layout: fixed; width:95%;">
        ...
        <tr>
            ...
            <td style="background:#f7f7f7; font-weight:bold; font-size:10px; text-align:center; width:30%;">Counseling Purpose</td>
            <td style="background:#f7f7f7; font-weight:bold; font-size:10px; text-align:center; width:30%;">Counselor Name</td>
