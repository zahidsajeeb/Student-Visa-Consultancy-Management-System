    ...
    <div class="col-lg-4">
        ...
        <select class="form-control required form-control-select2 education_level" id="select1" name="education_level" style="display: block;!important;">
            ...
            <optgroup label="Secondary">
                <option value="Grade 9"  class="secondary">Grade 9</option>
                <option value="Grade 10" class="secondary">Grade 10</option>
...
<div class="row">
    <div class="col-lg-4">
        ...
        <div id="Secondary_Education_Percentage_Scale" class="colors" style="display: none;">
            <div class="form-group">
                <label style="color:black;font-weight:500;">Grade Average <span>*</span></label>
                <input type="text" name="grade_avg_2" class="form-control" autocomplete="off">
            </div>
        </div>
        <div id="Secondary_Education_Grade_Point" class="colors" style="display: none;">
            <div class="form-group">
                <label style="color:black;font-weight:500;">Grade Average <span>*</span></label>
                <input type="text" name="grade_avg_3" class="form-control" autocomplete="off">
            </div>
        </div>
        ...
        <div id="Higher_Education_Percentage_Scale" class="colors" style="display: none;">
            <div class="form-group">
                <label style="color:black;font-weight:500;">Grade Average <span>*</span></label>
                <input type="text" name="grade_avg_5" class="form-control" autocomplete="off">
            </div>
        </div>
        <div id="Higher_Education_Grade_Point" class="colors" style="display: none;">
            <div class="form-group">
                <label style="color:black;font-weight:500;">Grade Average <span>*</span></label>
                <input type="text" name="grade_avg_6" class="form-control" autocomplete="off">
            </div>
        </div>
...
<hr>
<div class="primary hide_box">
    <div class="row ">
        <h4 class="mt-2" style="font-weight:bold;text-align:center;">Schools Attended :</h4>
        <div id="box" style="width:100%;">
            <div class="row">
                <div class="col-lg-4" style="top:10px;">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Country of Institution: <span>*</span></label>
                        <select class="form-control required form-control-select2" name="addmore_one[1][institution_country]">
                            <option value="Afghanistan">Afghanistan</option>
                            <option value="Åland Islands">Åland Islands</option>
                            <option value="Albania">Albania</option>
                            <option value="Algeria">Algeria</option>
                ...
                <div class="col-lg-4" style="top:10px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="addmore_one[1][institution_name]" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4" style="top:10px;">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Level of Education: <span>*</span></label>
                        <input type="text" name="addmore_one[1][education_level]" class="form-control" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="addmore_one[1][primary_language_instruction]" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Attended Institution From: <span>*</span></label>
                        <input type="date" name="addmore_one[1][institution_from]" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Attended Institution To: <span>*</span></label>
                        <input type="date" name="addmore_one[1][institution_to]" class="form-control" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="addmore_one[1][institution_degree]" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Address: <span>*</span></label>
                        <input type="text" name="addmore_one[1][institution_address]" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">City/Town: <span>*</span></label>
                        <input type="text" name="addmore_one[1][institution_city]" class="form-control" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="addmore_one[1][institution_province]" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Zip Code:</label>
                        <input type="text" name="addmore_one[1][institution_zip]" class="form-control" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="file" name="certificate_img_one[]" class="form-control multifile" accept="gif|jpg|pdf" data-maxfile="1024" autocomplete="off" multiple>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="file" name="transcript_img_one[]" class="form-control multifile" accept="gif|jpg|pdf" autocomplete="off" multiple>
                        <span style="color:red;">(***File Must be jpg, jpeg, png, pdf***)</span>
                    </div>
                </div>
        ...
        <div id="box" style="width:100%;">
            <div class="row">
                <div class="col-lg-4" style="top:10px;">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Country of Institution: <span>*</span></label>
                        <select class="form-control required form-control-select2" required name="addmore_one[1][institution_country]">
                            <option value="Afghanistan">Afghanistan</option>
                            <option value="Åland Islands">Åland Islands</option>
                            <option value="Albania">Albania</option>
                            <option value="Algeria">Algeria</option>
...
<div class="undergraduate hide_box">
    <div class="row ">
        <h4 class="mt-2" style="font-weight:bold;text-align:center;">Schools Attended :</h4>
        <div id="box" style="width:100%;">
            <div class="row">
                ...
                <div class="col-lg-4" style="top:10px;">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Name of Institution: <span>*</span></label>
                        <input type="text" name="addmore_one[1][institution_name]" class="form-control required" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4" style="top:10px;">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Level of Education: <span>*</span></label>
                        <input type="text" name="addmore_one[1][education_level]" class="form-control required" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Primary Language of Instructions: <span>*</span></label>
                        <input type="text" name="addmore_one[1][primary_language_instruction]" class="form-control required" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Attended Institution From: <span>*</span></label>
                        <input type="date" name="addmore_one[1][institution_from]" class="form-control required" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Attended Institution To: <span>*</span></label>
                        <input type="date" name="addmore_one[1][institution_to]" class="form-control required" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <label style="color:black;font-weight:500;">Address: <span>*</span></label>
                        <input type="text" name="addmore_one[1][institution_address]" class="form-control required" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
...
<div class="postgraduate hide_box">
    <div class="row ">
        <h4 class="mt-2" style="font-weight:bold;text-align:center;">Schools Attended :</h4>
        <div id="box" style="width:100%;">
            <div class="row">
...
<div class="row" id="add_more_one" style="display: none;">
    <h4 class="mt-2" style="font-weight:bold;text-align:center;">Schools Attended :</h4>
    <div id="box" style="width:100%;">
        <div class="row">
            <div class="col-md-12" style="text-align:right;">
                <button type="button" class="btn btn-primary btn-sm" onclick="add_more_two('add_more_two', 'inline');" style="border-radius:0px;"><i class="fa fa-plus" aria-hidden="true"></i> Add Attended</button>
                <button type="button" class="btn btn-danger btn-sm"  onclick="add_more_two('add_more_two', 'none');"   style="cursor:pointer;border-radius:0px;"><p><i class="fa fa-close"></i> Remove</p></button>
            </div>
            <div class="col-lg-4" style="top:10px;">
                <div class="form-group">
                    <label style="color:black;font-weight:500;">Country of Institution12: <span>*</span></label>
                    <select class="form-control required form-control-select2" required name="addmore_one[1][institution_country]">
                        <option value="Afghanistan">Afghanistan</option>
                        <option value="Åland Islands">Åland Islands</option>
                        <option value="Albania">Albania</option>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <label style="color:black;font-weight:500;">Certificate</label>
                    <input type="file" name="certificate_img_one[]" class="form-control multifile" accept="gif|jpg|pdf" autocomplete="off" multiple>
                    <span style="color:red;">(***File Must be jpg, jpeg, png, pdf***)</span>
                </div>
            </div>
            <div class="col-lg-4">
...
<div class="row" id="add_more_two" style="display: none;">
    <h4 class="mt-2" style="font-weight:bold;text-align:center;">Schools Attended :</h4>
    <div id="box" style="width:100%;">
        <div class="row">
            <div class="col-md-12" style="text-align:right;">
                <button type="button" class="btn btn-primary btn-sm" style="border-radius:0px;"><i class="fa fa-plus" aria-hidden="true"></i> Add Attended</button>
...
<div class="row" id="add_more_three" style="display: none;">
    <h4 class="mt-2" style="font-weight:bold;text-align:center;">Schools Attended :</h4>
    <div id="box" style="width:100%;">
        <div class="row">
            <div class="col-md-12" style="text-align:right;">
...
<div class="row" id="add_more_four" style="display: none;">
    <h4 class="mt-2" style="font-weight:bold;text-align:center;">Schools Attended :</h4>
    <div id="box" style="width:100%;">
        <div class="row">
            <div class="col-md-12" style="text-align:right;">
