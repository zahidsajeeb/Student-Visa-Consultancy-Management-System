...
<div class="row">
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="f_name" class="form-control required" required value="{{old('f_name')}}" autocomplete="off">
        </div>
    </div>
    <div class="col-lg-4">
        <div class="form-group">
    ...
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="l_name" class="form-control required" required value="{{old('l_name')}}"  autocomplete="off">
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="first_language" class="form-control required" required value="{{old('first_language')}}" autocomplete="off">
        </div>
    </div>
    <div class="col-lg-4">
        <div class="form-group">
            <label style="color:black;font-weight:500;">Citizenship <span>*</span></label>
            <input type="text" name="citizenship" class="form-control required" required value="{{old('citizenship')}}" autocomplete="off">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="passport_no" class="form-control required" required value="{{old('passport_no')}}" autocomplete="off">
        </div>
    </div>
    <div class="col-lg-4">
        <div class="form-group">
    ...
    <div class="col-lg-2">
        <div class="form-group">
            ...
            <select class="form-control required" name="marital_status" required value="{{old('marital_status')}}" style="border-radius:0px;">
    ...
    <div class="col-lg-2">
        <div class="form-group">
            ...
            <select class="form-control required" name="gender" required value="{{old('gender')}}" style="border-radius:0px;">
                <option value="">-Select-</option>
...
<div class="row">
    <div class="col-lg-8">
        <div class="form-group">
            ...
            <textarea class="form-control required" required name="address" value="{{old('address')}}" style="border-radius:0px; border-color: #604c4c69 !important;"></textarea>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="form-group">
            <label style="color:black;font-weight:500;">City/Town <span>*</span></label>
            <input type="text" name="city" class="form-control required" required value="{{old('city')}}" autocomplete="off">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control required form-control-select2" required name="country">
    ...
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="state" class="form-control required" required value="{{old('state')}}" autocomplete="off">
        </div>
    </div>
    <div class="col-lg-4">
        <div class="form-group">
            <label style="color:black;font-weight:500;">Postal/Zip Code <span>*</span></label>
            <input type="text" name="zip_code" class="form-control required" required value="{{old('zip_code')}}" autocomplete="off">
        </div>
    </div>
</div>
<div class="row">
