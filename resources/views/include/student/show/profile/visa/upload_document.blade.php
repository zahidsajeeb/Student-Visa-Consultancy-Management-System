                ...
                @if($row->type=='Passport')
                    <tr>
                        ...
                        <td>
                            ...
                            @endif
                            @if(($row->admission_status=='0') && ($row->visa_status=='0'))
                                <button class="btn btn-success" data-toggle="modal" data-target=".successPassportModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-check"></i> Accept</button>
                                <button class="btn btn-danger" data-toggle="modal" data-target=".rejectPassportModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-close"></i> Reject</button>
                            @endif
                        </td>
                        <div class="modal fade successPassportModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                            <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                        ...
                        <div class="modal fade rejectPassportModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                            <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <h6 class="modal-title"><i class="icin icon-checkbox-checked"></i> Confirmation Form</h6>
