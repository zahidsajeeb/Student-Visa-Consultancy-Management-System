        ...
        <td colspan="5">
            <table class="table table-bordered">
                <tr style="background: #f4f4f4;font-weight: bold;">
                    <td style="width:25%!important;">File View</td>
                    <td style="width:35%!important;">Visa Comment</td>
                    <td style="width:20%!important;">Status</td>
                    <td style="width:20%!important;">Action</td>
                </tr>
                    ...
                    @if($row->type=='IELTS')
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                @if(($row->admission_status=='0') && ($row->visa_status=='0'))
                                    <button class="btn btn-success" data-toggle="modal" data-target=".successIeltsModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-check"></i> Accept</button>
                                    <button class="btn btn-danger" data-toggle="modal" data-target=".rejectIeltsModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-close"></i> Reject</button>
                                @endif
                            </td>
                            <div class="modal fade successIeltsModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                            ...
                            <div class="modal fade rejectIeltsModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                            <h6 class="modal-title"><i class="icin icon-checkbox-checked"></i> Confirmation Form</h6>
                    ...
                    @if($row->type=='PTE')
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                @if(($row->admission_status=='0') && ($row->visa_status=='0'))
                                    <button class="btn btn-success" data-toggle="modal" data-target=".successPteModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-check"></i> Accept</button>
                                    <button class="btn btn-danger" data-toggle="modal" data-target=".rejectIePteModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-close"></i> Reject</button>
                                @endif
                            </td>
                            <div class="modal fade successPteModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                            <h6 class="modal-title"><i class="icin icon-checkbox-checked"></i> Confirmation Form</h6>
                            ...
                            <div class="modal fade rejectPteModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                            <h6 class="modal-title"><i class="icin icon-checkbox-checked"></i> Confirmation Form</h6>
                    ...
                    @if($row->type=='Duolingo')
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                @if(($row->admission_status=='0') && ($row->visa_status=='0'))
                                    <button class="btn btn-success" data-toggle="modal" data-target=".successDuolingoModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-check"></i> Accept</button>
                                    <button class="btn btn-danger" data-toggle="modal" data-target=".rejectDuolingoModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-close"></i> Reject</button>
                                @endif
                            </td>
                            <div class="modal fade successDuolingoModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                            <h6 class="modal-title"><i class="icin icon-checkbox-checked"></i> Confirmation Form</h6>
                            ...
                            <div class="modal fade rejectDuolingoModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                            <h6 class="modal-title"><i class="icin icon-checkbox-checked"></i> Confirmation Form</h6>
...
<tr>
    ...
    <td colspan="6">
        <table class="table table-bordered">
            <tr style="background: #f4f4f4;font-weight: bold;">
                <td style="width:25%!important;">Test Score Comment</td>
                <td style="width:25%!important;">Visa Comment</td>
                <td style="width:20%!important;">Action</td>
            </tr>
            <form action="{{url('test_score_visa_comment_store')}}" method="post">
                @csrf
                <tr>
                    <td>
                        <p>
                            @if($profile_data->test_score_visa_comment)
                                {{$profile_data->test_score_visa_comment}}
                            @else
                                <span> No comments here ...</span>
                            @endif
                        </p>
                    ...
                    <td>
                        <textarea name="test_score_visa_comment" style="width:100%;height:100px;border:1px solid #726e6e3b;" placeholder="Type okay or suggest where need to corrections . . ."></textarea>
                    ...
                    @if($row->type=='GRE')
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                @if(($row->admission_status=='0') && ($row->visa_status=='0'))
                                    <button class="btn btn-success" data-toggle="modal" data-target=".successGreModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-check"></i> Accept</button>
                                    <button class="btn btn-danger" data-toggle="modal" data-target=".rejectGreModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-close"></i> Reject</button>
                                @endif
                            </td>
                            <div class="modal fade successGreModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                            <h6 class="modal-title"><i class="icin icon-checkbox-checked"></i> Confirmation Form</h6>
                            ...
                            <div class="modal fade rejectGreModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                            <h6 class="modal-title"><i class="icin icon-checkbox-checked"></i> Confirmation Form</h6>
                    ...
                    @if($row->type=='GMAT')
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                @if(($row->admission_status=='0') && ($row->visa_status=='0'))
                                    <button class="btn btn-success" data-toggle="modal" data-target=".successGmatModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-check"></i> Accept</button>
                                    <button class="btn btn-danger" data-toggle="modal" data-target=".rejectGmatModal<?php echo $row->id; ?>" style="border-radius:0px;"><i class="fa fa-close"></i> Reject</button>
                                @endif
                            </td>
                            <div class="modal fade successGmatModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                            <h6 class="modal-title"><i class="icin icon-checkbox-checked"></i> Confirmation Form</h6>
                            ...
                            <div class="modal fade rejectGmatModal<?php echo $row->id; ?>" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                    <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                            <h6 class="modal-title"><i class="icin icon-checkbox-checked"></i> Confirmation Form</h6>
...
<tr>
    ...
    <td colspan="6">
        <table class="table table-bordered">
            ...
            <form action="{{url('additional_qualification_visa_comment_store')}}" method="post">
                @csrf
                <tr>
                    <td>
                        <p>
                            @if($profile_data->additional_qualification_visa_comment)
                                {{$profile_data->additional_qualification_visa_comment}}
                            @else
                                <span> No comments here ...</span>
                            @endif
                        </p>
                    ...
                    <td>
                        <textarea name="additional_qualification_visa_comment" style="width:100%;height:100px;border:1px solid #726e6e3b;" placeholder="Type okay or suggest where need to corrections . . ."></textarea>
                        <input type="hidden" name="id" value="{{$profile_data->id}}">
                    </td>
                    <td>
                        <button type="submit" class="btn btn-success" style="border-radius:0px;"><i class="fa fa-check"></i> Submit</button>
