    ...
    <td colspan="5">
        <table class="table table-bordered">
            <tr style="background: #f4f4f4;font-weight: bold;">
                <td style="width:25%!important;">Personal Information Comment</td>
                <td style="width:25%!important;">Visa Comment</td>
                <td style="width:20%!important;">Action</td>
            </tr>
            <form action="{{url('personal_information_visa_comment_store')}}" method="post">
                @csrf
                <tr>
                    <td>
                        <p>
                            @if($profile_data->personal_info_visa_comment)
                                {{$profile_data->personal_info_visa_comment}}
                            @else
                    ...
                    <td>
                        <textarea name="personal_info_visa_comment" style="width:100%;height:100px;border:1px solid #726e6e3b;" placeholder="Type okay or suggest where need to corrections . . ."></textarea>
