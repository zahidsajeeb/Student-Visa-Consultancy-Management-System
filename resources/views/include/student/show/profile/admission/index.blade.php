<div class="table-responsive">
    <table class="table table-bordered">
        @include('.include.student.show.profile.admission.general_information')
        @include('.include.student.show.profile.admission.educational_background')
        @include('.include.student.show.profile.admission.test_score')
        @include('.include.student.show.profile.admission.background_information')
        @include('.include.student.show.profile.admission.upload_document')
         @include('.include.student.show.profile.admission.country_program')
    </table>
...
{{--                            </td>--}}
{{--                            <td>--}}
{{--                                <button type="button" name="add" id="add_more_sample" class="btn btn-success btn-sm" style="width:100px;border-radius:0px;"><i class="fa fa-plus"></i> Add More</button>--}}
{{--                                <br>--}}
{{--                                <button type="submit" class="btn btn-sm btn-info" style="border-radius:0px; margin-top:5px; width:100px;"><i class="fa fa-check"></i> Submit</button>--}}
{{--                            </td>--}}
{{--                        </tr>--}}
