...
@if(($profile_data->education_level=="Grade 1")===true || ($profile_data->education_level=="Grade 2")===true || ($profile_data->education_level=="Grade 3")===true || ($profile_data->education_level=="Grade 4")===true || ($profile_data->education_level=="Grade 5")===true || ($profile_data->education_level=="Grade 6")===true ||
($profile_data->education_level=="Grade 7")===true || ($profile_data->education_level=="Grade 8")===true || ($profile_data->education_level=="Grade 9")===true || ($profile_data->education_level=="Grade 10")===true)
    <tr>
...
@if(($profile_data->education_level=="Postgraduate Certificate/Diploma")===true || ($profile_data->education_level=="Master Degree")===true || ($profile_data->education_level=="Doctoral Degree (Phd, M.D . .)")===true)
    ...
    @foreach($education_data as $row)
        ...
        <tr>
            <td style="background:#f4f4f4;font-weight:bold;">Postgraduate Uploaded File:</td>
            <td colspan="5">
                <table class="table table-bordered">
                    <tr>
                        <td style="background:gray;color:white;width:25%!important;">File View</td>
                ...
                <table class="table table-bordered">
                    ...
                    @foreach($document_data as $row)
                        @if($row->type=='Postgraduate')
                            <tr>
                                <td>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_double_postgraduate<?php echo $row->id; ?>" style="border-radius:0px"><i class="icon-file-pdf ml-2"></i>
                                        {{$row->category}} File View
                                    </button>
                                    <div id="modal_double_postgraduate<?php echo $row->id; ?>" class="modal fade" tabindex="-1" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                        <div class="modal-dialog modal-lg" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                            <div class="modal-content" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                                <div class="modal-header bg-indigo text-white" style="border-color: #604c4c69 !important; border-radius:0px !important;">
                                                    <h6 class="modal-title"><i class="icon icon-checkbox-checked"></i> {{$row->category}} File</h6>
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
                                                <div class="modal-body">
...
<tr>
    ...
    <td colspan="5">
        <table class="table table-bordered">
            ...
            <form action="{{url('educational_summery_admission_comment_store')}}" method="post">
                @csrf
                <tr>
                    <td>
                        <p>
                            @if($profile_data->education_summary_admission_comment)
                                {{$profile_data->education_summary_admission_comment}}
                            @else
                                <span> No comments here ...</span>
                            @endif
                        </p>
                    ...
                    <td>
                        <textarea name="education_summary_admission_comment" style="width:100%;height:100px;border:1px solid #726e6e3b;" placeholder="Type okay or suggest where need to corrections . . ."></textarea>
