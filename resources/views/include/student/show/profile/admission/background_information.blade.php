...
<tr>
    ...
    <td colspan="6">
        <table class="table table-bordered">
            ...
            <form action="{{url('background_information_admission_comment_store')}}" method="post">
                @csrf
                <tr>
                    <td>
                        <p>
                            @if($profile_data->background_information_admission_comment)
                                {{$profile_data->background_information_admission_comment}}
                            @else
                    ...
                    <td>
                        <textarea name="background_information_admission_comment" style="width:100%;height:100px;border:1px solid #726e6e3b;" placeholder="Type okay or suggest where need to corrections . . ."></textarea>
