<div class="table-responsive">
    <table class="table table-bordered">
        @include('.include.student.show.profile.counselor.general_information')
        @include('.include.student.show.profile.counselor.educational_background')
        @include('.include.student.show.profile.counselor.test_score')
        @include('.include.student.show.profile.counselor.background_information')
        @include('.include.student.show.profile.counselor.upload_document')
         @include('.include.student.show.profile.counselor.country_program')
    </table>
</div>
