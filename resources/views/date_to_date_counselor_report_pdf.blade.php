...
<div class="invoice">
    ...
    <table border="1" style="table-layout: fixed; width:95%;">
        <tr>
            <td colspan="10" style="background:#083078d4; font-weight:bold; color:wheat; text-align:center;"> Student Information</td>
        </tr>
        <tr>
            ...
            <td style="background:#f7f7f7; font-weight:bold; font-size:10px; text-align:center;">Payement Status</td>
            <td style="background:#f7f7f7; font-weight:bold; font-size:10px; text-align:center;">Profile Status</td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:30%; text-align:center; font-size:10px; word-break:break-all; word-wrap:break-word;">{{$row->student_name}}</td>
            <td style="width:20%; text-align:center; font-size:10px; word-break:break-all; word-wrap:break-word;">{{ $row->student_id}}</td>
            <td style="width:15%; text-align:center; font-size:10px; word-break:break-all; word-wrap:break-word;">{{$row->date}}</td>
            ...
            <td style="width:13%; text-align:center; font-size:10px;">
                @if($row->cc_status==0)
                    Under Process
                @endif
                @if($row->cc_status==1)
