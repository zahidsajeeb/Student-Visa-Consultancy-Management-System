    ...
    <table border="1" style="table-layout: fixed; width:95%;">
        <tr>
            <td colspan="10" style="background:#083078d4; font-weight:bold; color:wheat; text-align:center;">
                @if($profile_status==0)
                    Pending Student Profile | Date: <?php echo $start_date;?> - <?php echo $end_date;?>
                @endif
                @if($profile_status==1)
                    Complete Student Profile | Date: <?php echo $start_date;?> - <?php echo $end_date;?>
                @endif
            </td>
        </tr>
        <tr>
            ...
            <td style="background:#f7f7f7; font-weight:bold; font-size:10px; text-align:center;">Payment Status</td>
        </tr>
