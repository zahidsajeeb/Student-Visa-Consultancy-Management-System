        ...
        <div class="content-inner">
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Immigration Student List</h4>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title" style="font-weight:bold;text-align:center;">Immigration Student List</h5>
                                <hr>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="operator_immigration_table" style="border:1px solid;">
            ...
            <script>
                ...
                $(function () {
                    ...
                    var operator_immigration_table = $('#operator_immigration_table').DataTable({
                        processing: true,
                        serverSide: false,
                        searchable: true,
                        ajax: "{{ url('immigration_list') }}",
                        columns: [
            ...
            <div class="content-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="admission_immigration_table" style="border:1px solid gray;">
                                            <thead style="background-color:#194d83; color:white;">
                                            <tr>
                ...
                <script>
                    ...
                    $(function () {
                        ...
                        var admission_immigration_table = $('#admission_immigration_table').DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: "{{ url('immigration_list') }}",
                            columns: [
            ...
            <div class="content-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="counselor_immigration_table" style="border:1px solid gray; text-align:center;">
                                            <thead style="background-color:#194d83; color:white;">
                                            <tr>
                                                <th style="width:20px;">#</th>
                                                <th class="text-center" style="width:70px;">Action</th>
                ...
                <script>
                    ...
                    $(function () {
                        ...
                        var counselor_immigration_table = $('#counselor_immigration_table').DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: "{{ url('immigration_list') }}",
                            columns: [
