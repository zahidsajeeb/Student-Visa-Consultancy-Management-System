        ...
        <div class="content-inner">
            <div class="page-header page-header-light">
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-title d-flex">
                        <h4><i class="icon-home"></i> <span class="font-weight-semibold">Home</span> - Schooling Visa List</h4>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title" style="font-weight:bold;text-align:center;">Schooling Visa List</h5>
                                <hr>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="operator_medi_table" style="border:1px solid;">
            ...
            <script>
                ...
                $(function () {
                    ...
                    var operator_medi_table = $('#operator_medi_table').DataTable({
                        processing: true,
                        serverSide: false,
                        searchable: true,
                        ajax: "{{ url('meditourism_list') }}",
                        columns: [
            ...
            <div class="content-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="admission_medi_table" style="border:1px solid gray;">
                                            <thead style="background-color:#194d83; color:white;">
                                            <tr>
                ...
                <script>
                    ...
                    $(function () {
                        ...
                        var immigration_table = $('#admission_medi_table').DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: "{{ url('meditourism_list') }}",
                            columns: [
            ...
            <div class="content-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="counselor_medi_table" style="border:1px solid gray;">
                                            <thead style="background-color:#194d83; color:white;">
                                            <tr>
                                                <th style="width:20px;">#</th>
                                                <th class="text-center" style="width:70px;">Action</th>
                ...
                <script>
                    ...
                    $(function () {
                        ...
                        var immigration_table = $('#counselor_medi_table').DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: "{{ url('meditourism_list') }}",
                            columns: [
