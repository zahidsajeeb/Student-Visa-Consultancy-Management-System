                            ...
                            <div class="content-wrapper">
                                <div class="content-inner">
                                    <div class="page-header page-header-light">
                                        <div class="page-header-content header-elements-lg-inline">
                                            <div class="page-title d-flex">
                                                <h4><i class="icon-home"></i> Home - <span class="font-weight-semibold"></span>Visa Section </h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="content">
                                        ...
                                        @endif
                                        @if($visa_important_data_count !=0)
                                            <div class="card-group-control card-group-control-right">
                                                <div class="card mb-2">
                                                    <div class="card-header">
                                                        <h6 class="card-title">
                                                            <a class="text-body collapsed" data-toggle="collapse" href="#visa">
                                                                <i class="icon-help mr-2 text-secondary"></i> Visa Section Important Documents
                                                            </a>
                                                        </h6>
                                                    </div>
                                                    <div id="visa" class="collapse1">
                                                        <div class="card-body">
                                                                                        ...
                                                                                        <form action="{{ url('important_file_update')}}" method="POST" enctype="multipart/form-data">
                                                                                            ...
                                                                                            <td>
                                                                                                @if($row->visa_req_file==true)
                                                                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_visa_file<?php echo $row->id; ?>" style="border-radius:0px;"><i
                                                                                                            class="icon-file-pdf ml-2"></i>
                                                                                                        File View
                                                                                                    </button>
                                                                                                    <div id="modal_visa_file<?php echo $row->id; ?>" class="modal fade" tabindex="-1" style="border-radius:0px;">
                                                                                                        <div class="modal-dialog  modal-lg">
                                                                                                            <div class="modal-content">
                                                                                                                ...
                                                                                                                <div class="modal-body">
                                                                                                                    <embed src="upload/imp_file/visa/<?php echo $row->visa_req_file ?>" frameborder="0" width="100%" height="780">
                                                                                                                    <hr>
