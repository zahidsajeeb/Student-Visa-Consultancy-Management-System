        ...
        <div class="content-inner">
            <div class="page-content">
                @if(Auth::user()->role==='Admin')
                    @include('include.admin.index')
                @endif
                @if(Auth::user()->role==='Admission Section')
                    @include('include.admission.index')
                @endif
                @if(Auth::user()->role==='Counselor')
                    @include('include.counselor.index')
                @endif
                @if(Auth::user()->role==='Operator')
                    @include('include.frontdesk.index')
                @endif
                @if(Auth::user()->role==='Student')
                    @include('include.student.index')
                @endif
                @if(Auth::user()->role==='Visa Section')
                    @include('include.visa.index')
                @endif
                @if(Auth::user()->role==='Accountant')
                    @include('include.accounts.index')
                @endif
            </div>
