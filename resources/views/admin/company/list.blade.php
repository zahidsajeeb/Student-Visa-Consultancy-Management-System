            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Company Lists</h5>
                    </div>
                    <div class="card-body">
                        <button type="button" class="btn btn-indigo" data-toggle="modal" data-target="#modal_theme_custom">Add Company <i class="icon-play3 ml-2"></i></button>
                    </div>
...
{{--                                            <a href="#" class="dropdown-item"><i class="icon-file-excel"></i>Edit</a>--}}
{{--                                            <a href="#" class="dropdown-item"><i class="icon-file-word"></i> Delete</a>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </td>--}}
                ...
                <div id="modal_theme_custom" class="modal fade" tabindex="-1">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form action="{{ url('company_store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <fieldset>
                                        <div class="collapse show" id="demo1">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control h-auto" name="company_name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label">Company Address:</label>
                                                <div class="col-lg-8">
                                                    <textarea class="form-control h-auto" name="company_address"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <fieldset>
                                        <div class="collapse show" id="demo1">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <img id="modal-preview"  alt="Preview" class="form-group" width="100" height="100">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label">Company Logo Preview:</label>
